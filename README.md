...
# Issues
You can always create an [issue](https://github.com/mvmorin/queller-bot/issues) but I'm currently not planing on developing this much further than the current rough state. However, if I get back to this project they might still be useful.
